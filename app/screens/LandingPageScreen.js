    ...
    return (
        <Screen style={{ flex: 1, justifyContent: 'flex-start', alignItems: "center", backgroundColor: Colors.primary }}>
            ...
            <View style={{ marginTop: RFPercentage(10), width: '90%', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }} >
                <Text style={{ fontWeight: '600', color: Colors.white, fontSize: RFPercentage(2.5), textAlign: 'center' }} >
                    Discover your Dream
                </Text>
                <Text style={{ marginTop: RFPercentage(1), fontWeight: '600', color: Colors.white, fontSize: RFPercentage(2.5), textAlign: 'center' }} >
                    job here
                </Text>
            </View>

            <View style={{ marginTop: RFPercentage(2.5), width: '90%', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }} >
                <Text style={{ color: Colors.white, fontSize: RFPercentage(2), textAlign: 'center', opacity: 0.8 }} >
                    Explore all the most exiting jobs roles
                </Text>
                <Text style={{ marginTop: RFPercentage(0.5), color: Colors.white, fontSize: RFPercentage(2), textAlign: 'center', opacity: 0.8 }} >
